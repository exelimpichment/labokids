...
const PageHeroDummy: React.FC<IPageHero> = ({
    ...
    <section>
      <div className="h-screen">
        <div className="absolute -z-10 h-screen w-full">
          <Image
            src={offeredServicesObj['bilingual'].image}
            fill
        ...
        <Container>
          <div
            className={`flex flex-col ${offeredServicesObj['bilingual'].flexPosition} pb-5`}
          >
            <div
              className={`mt-[10vh] sm:mt-[25vh] lg:mt-[40vh] lg:max-w-[60%] landscape:sm:mt-[10vh] landscape:lg:mt-[25vh] landscape:xl:mt-[35vh]  ${offeredServicesObj['bilingual'].textPosition} text-center `}
            >
              <p
              ...
              <h1
                className={`${titleFont.className} pb-5 text-4xl text-white lg:pb-5 xl:text-5xl`}
              >
                {header}
              </h1>
              <p
                className={`${textFont.className} text-xl  font-bold text-white`}
              >
                {paragraph}
              </p>
            </div>
          ...
          <ButtonsHero
            buttonsPosition={offeredServicesObj['bilingual'].buttonsPosition}
